Voici votre code avec une indentation correcte, sans aucune autre modification :
...
# 2eme essai : on essaie d'avoir un maillage triangulaire de la surface 3D du nuage de points. Fonctionne!
