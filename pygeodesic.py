"""
> Ce code prends en entrée un maillage .txt basique (points/faces)
> Il renvoie les distances géodésiques (sous forme de dégradé de couleurs) de
chaque point à un bord préalablement défini qui utilise le maillage pour
calculer les distances géo
> Fonctionne en 3D
"""
